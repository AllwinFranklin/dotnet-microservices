...
namespace Ordering.Application.Features.Orders.Commands.CheckoutOrder
{
    public class CheckoutOrderCommandHandler : IRequestHandler<CheckoutOrderCommand, int>
    {
        ...
        private async Task sendMail(Task<Order> newOrder)
        {
            var email = new Email() { To = "allwinantofranklin@gmail.com", Body = $"Order {newOrder.Id} was created.", Subject = "Order was created" };
            try
            {
